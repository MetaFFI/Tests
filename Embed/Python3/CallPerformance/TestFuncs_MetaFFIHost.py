...
DoNothing_id = cfunctype_no_params_no_ret(xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_function=EntryPoint_DoNothing,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/mnt/c/src/github.com/MetaFFI/Tests/Embed/Python3/CallPerformance,package=TestFuncs'.encode("utf-8"), len('module=/mnt/c/src/github.com/MetaFFI/Tests/Embed/Python3/CallPerformance,package=TestFuncs,entrypoint_function=EntryPoint_DoNothing,metaffi_guest_lib=TestFuncs_MetaFFIGuest'.encode("utf-8")), DoNothing_id, 0, 0, out_err, out_err_len))
