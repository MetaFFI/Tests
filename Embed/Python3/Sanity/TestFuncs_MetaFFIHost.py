...
HelloWorld_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_function=EntryPoint_HelloWorld,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('entrypoint_function=EntryPoint_HelloWorld,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8")), HelloWorld_id, out_err, out_err_len)
if HelloWorld_id == -1: # failed to load function
	err_text = string_at(out_err.contents, out_err_len.contents.value)
	raise RuntimeError('\n'+str(err_text).replace("\\n", "\n"))

ReturnsAnError_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_function=EntryPoint_ReturnsAnError,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('package=TestFuncs,entrypoint_function=EntryPoint_ReturnsAnError,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity'.encode("utf-8")), ReturnsAnError_id, out_err, out_err_len)
if ReturnsAnError_id == -1: # failed to load function
	err_text = string_at(out_err.contents, out_err_len.contents.value)
	raise RuntimeError('\n'+str(err_text).replace("\\n", "\n"))

DivIntegers_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_function=EntryPoint_DivIntegers,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('entrypoint_function=EntryPoint_DivIntegers,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8")), DivIntegers_id, out_err, out_err_len)
if DivIntegers_id == -1: # failed to load function
	err_text = string_at(out_err.contents, out_err_len.contents.value)
	raise RuntimeError('\n'+str(err_text).replace("\\n", "\n"))

JoinStrings_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs,entrypoint_function=EntryPoint_JoinStrings,metaffi_guest_lib=TestFuncs_MetaFFIGuest'.encode("utf-8"), len('entrypoint_function=EntryPoint_JoinStrings,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8")), JoinStrings_id, out_err, out_err_len)
if JoinStrings_id == -1: # failed to load function
	err_text = string_at(out_err.contents, out_err_len.contents.value)
	raise RuntimeError('\n'+str(err_text).replace("\\n", "\n"))

WaitABit_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs,entrypoint_function=EntryPoint_WaitABit,metaffi_guest_lib=TestFuncs_MetaFFIGuest'.encode("utf-8"), len('metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs,entrypoint_function=EntryPoint_WaitABit'.encode("utf-8")), WaitABit_id, out_err, out_err_len)
...
TestMap_NewTestMap_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_function=EntryPoint_TestMap_NewTestMap,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('entrypoint_function=EntryPoint_TestMap_NewTestMap,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8")), TestMap_NewTestMap_id, out_err, out_err_len)
...
TestMap_GetName_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'metaffi_guest_lib=TestFuncs_MetaFFIGuest,entrypoint_function=EntryPoint_TestMap_GetName'.encode("utf-8"), len('entrypoint_function=EntryPoint_TestMap_GetName,metaffi_guest_lib=TestFuncs_MetaFFIGuest'.encode("utf-8")), TestMap_GetName_id, out_err, out_err_len)
...
TestMap_Set_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_class=TestMap,entrypoint_function=EntryPoint_TestMap_Set,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs,entrypoint_class=TestMap,entrypoint_function=EntryPoint_TestMap_Set,metaffi_guest_lib=TestFuncs_MetaFFIGuest'.encode("utf-8")), TestMap_Set_id, out_err, out_err_len)
if TestMap_Set_id == -1: # failed to load function
	err_text = string_at(out_err.contents, out_err_len.contents.value)
	raise RuntimeError('\n'+str(err_text).replace("\\n", "\n"))

TestMap_Get_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs,entrypoint_class=TestMap,entrypoint_function=EntryPoint_TestMap_Get'.encode("utf-8"), len('package=TestFuncs,entrypoint_class=TestMap,entrypoint_function=EntryPoint_TestMap_Get,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity'.encode("utf-8")), TestMap_Get_id, out_err, out_err_len)
if TestMap_Get_id == -1: # failed to load function
	err_text = string_at(out_err.contents, out_err_len.contents.value)
	raise RuntimeError('\n'+str(err_text).replace("\\n", "\n"))

TestMap_Contains_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_class=TestMap,entrypoint_function=EntryPoint_TestMap_Contains,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('entrypoint_function=EntryPoint_TestMap_Contains,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs,entrypoint_class=TestMap'.encode("utf-8")), TestMap_Contains_id, out_err, out_err_len)
...
TestMap_ReleaseTestMap_id = xllr_handle.load_function(runtime_plugin, len(runtime_plugin), 'entrypoint_function=EntryPoint_TestMap_ReleaseTestMap,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8"), len('entrypoint_function=EntryPoint_TestMap_ReleaseTestMap,metaffi_guest_lib=TestFuncs_MetaFFIGuest,module=/home/tcs/src/github.com/MetaFFI/Tests/Embed/Python3/Sanity,package=TestFuncs'.encode("utf-8")), TestMap_ReleaseTestMap_id, out_err, out_err_len)
