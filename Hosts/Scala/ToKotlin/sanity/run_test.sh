...
echo running tests
java -cp ".:Test_MetaFFIHost.jar:Test_MetaFFIGuest.jar:$METAFFI_HOME/xllr.openjdk.bridge.jar:$METAFFI_HOME/protobuf-java-3.15.2.jar:/usr/share/scala/lib/scala-library.jar:/snap/kotlin/current/lib/kotlin-stdlib.jar" Main_test
