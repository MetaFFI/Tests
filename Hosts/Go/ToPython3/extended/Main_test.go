...
func TestPositionalOrNamedMultiTypeHint1(t *testing.T) {
	...
	str, err := ext.Positional_Or_Named_Multi_Type_Hint_Overload1("arg1") // positional_or_named_multi_type_hint('arg1')
	if err != nil {
		t.Fatal(err)
	}
	if str != "arg1" {
...
func TestListArgs1(t *testing.T) {
	...
	listHandle, err := ext.List_Args_Overload1() // list_args()
	if err != nil {
		t.Fatal(err)
	}
...
func TestListArgs2(t *testing.T) {
	...
	listHandle, err := ext.List_Args_Overload2("None Default") // list_args('None Default')
	if err != nil {
		t.Fatal(err)
	}
...
func TestDictArgs1(t *testing.T) {
	...
	res, err := ext.Dict_Args_Overload1()
	if err != nil {
		t.Fatal(err)
	}
...
func TestDictArgs2(t *testing.T) {
	...
	res, err := ext.Dict_Args_Overload2("none-default")
	if err != nil {
		t.Fatal(err)
	}
...
func TestPositionalOnly1(t *testing.T) {
	...
	res, err := ext.Positional_Only_Overload1("word1")
	if err != nil {
		t.Fatal(err)
	}
...
func TestArgPositionalArgNamed1(t *testing.T) {
	...
	lstHandle, err := ext.Arg_Positional_Arg_Named_Overload1()
	if err != nil {
		t.Fatal(err)
	}
...
func TestArgPositionalArgNamed2(t *testing.T) {
	...
	lstHandle, err := ext.Arg_Positional_Arg_Named_Overload2("positional arg")
	if err != nil {
		t.Fatal(err)
	}
...
func TestArgPositionalArgNamed3(t *testing.T) {
	...
	lstHandle, err := ext.Arg_Positional_Arg_Named_Overload3("positional arg", listArgs.GetHandle())
	if err != nil {
		t.Fatal(err)
	}
