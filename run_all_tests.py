...
def main():
	try:
		run_test.execute_path('./Embed/Go/ToPython3/Sanity')
		run_test.execute_path('./Embed/Python3/Deque')
		run_test.execute_path('./Embed/Python3/CallPerformance')
		run_test.execute_path('./Embed/Python3/Sanity')
		...
		run_test.execute_path('./Hosts/Python3/ToGo/libraries/goutils')
